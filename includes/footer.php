...
<?php endif; ?>
    ...
    <footer class="footer text-center">
        <div class="container">
            ...
            <p>&copy; 2025 PromoPilot. <?php echo __('Все права защищены.'); ?> | <?php echo __('Версия'); ?>: <?php echo htmlspecialchars(get_version()); ?><?php if (!empty($upd['is_new'])): ?> | <?php echo __('Доступна версия'); ?>: v<?php echo htmlspecialchars($upd['latest']); ?><?php endif; ?></p>
